...
var hasOwn = class2type.hasOwnProperty;//是否为自身属性（不继承）
...
var rootjQuery,
	...
	init = jQuery.fn.init = function( selector, context, root ) {
		...
		if ( typeof selector === "string" ) {
			...
			// HANDLE: $(expr, $(...)) ？？？？？？？？？？？？？？
			// 如$("div"),match不存在，context不存在,在root域中寻找div
			// 如$("div",$()),match不存在,context存在且是jQuery对象，可以使用jQuery的find方法在context中查找div
